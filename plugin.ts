...
export default function register(api: PluginApi) {
  ...
  api.registerTool((ctx: ToolContext) => ({
    name: "goliath_act",
    description:
      "Perform human-like browser actions that are not covered by click/type: press a key, hover, wait, scroll an element into view, select options, or drag and drop.",
    parameters: {
      type: "object",
      properties: {
        tabId: { type: "string", description: "Tab identifier" },
