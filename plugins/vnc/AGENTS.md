...
Disabled by default. Enable with `ENABLE_VNC=1` env var or `"vnc": { "enabled": true }` in `goliath.config.json`.
...
- [@leoneparise](https://github.com/leoneparise) — original VNC implementation and keyboard mode
