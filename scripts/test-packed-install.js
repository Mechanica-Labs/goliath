...
try {
  ...
  if (manifest.name !== '@mechanica-labs/goliath' || manifest.version !== '0.2.0' || manifest.private !== false) {
  ...
  if (versionOutput !== '0.2.0') throw new Error(`packed CLI reported ${versionOutput}`);
  ...
  if (!generic.args.includes('@mechanica-labs/goliath@0.2.0')) throw new Error('packed harness config has the wrong npm identity');
